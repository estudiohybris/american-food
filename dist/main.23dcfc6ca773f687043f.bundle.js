...
document.addEventListener('DOMContentLoaded', function () {
  ...
  navLinks.forEach(link => {
    ...
    // Comparar el href con la URL actual y el hash
    if (href === currentPath || href === currentHash) {
      link.classList.add('active'); // Añadir la clase active
    } else {
      link.classList.remove('active'); // Asegurarse de remover la clase active si no coincide
    }
  });
});
...
/******/ });
//# sourceMappingURL=main.23dcfc6ca773f687043f.bundle.js.map