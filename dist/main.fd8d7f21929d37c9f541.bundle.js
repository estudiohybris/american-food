...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).ready(function () {
  // Añadir sombra a la navbar al hacer scroll
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).on('scroll', function () {
    const scroll = jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).scrollTop();
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(".navbar.navbar-expand-lg").toggleClass("shadow", scroll > 0);
  });
});
document.addEventListener('DOMContentLoaded', function () {
  ...
  const responsiveNavItems = [].slice.call(document.querySelectorAll('#navbarText .nav-link'));

  // Función para manejar el scroll y actualizar el enlace activo
  function handleScroll() {
    let fromTop = window.scrollY + getOffsetTop();
  ...
  // Escuchar el evento de scroll para actualizar las clases activas
  ...
  responsiveNavItems.map(function (responsiveNavItem) {
    responsiveNavItem.addEventListener('click', function (event) {
      ...
      const targetId = responsiveNavItem.getAttribute('href');
      const targetElement = document.querySelector(targetId);
      if (targetElement) {
        // Calcular la posición de desplazamiento
        const targetPosition = targetElement.offsetTop - getOffsetTop();
...
/******/ });
//# sourceMappingURL=main.fd8d7f21929d37c9f541.bundle.js.map